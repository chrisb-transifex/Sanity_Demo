"use strict";
var path = require("node:path"), generateHelpUrl_esm = require("./generate-help-url.esm.js"), resolveFrom = require("resolve-from"), semver = require("semver"), fs = require("node:fs"), fs$1 = require("node:fs/promises"), execa = require("execa"), oneline = require("oneline"), node_perf_hooks = require("node:perf_hooks");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var path__default = /* @__PURE__ */ _interopDefaultCompat(path), resolveFrom__default = /* @__PURE__ */ _interopDefaultCompat(resolveFrom), semver__default = /* @__PURE__ */ _interopDefaultCompat(semver), fs__default = /* @__PURE__ */ _interopDefaultCompat(fs), execa__default = /* @__PURE__ */ _interopDefaultCompat(execa), oneline__default = /* @__PURE__ */ _interopDefaultCompat(oneline), peerDependencies = {
  react: "^18",
  "react-dom": "^18",
...
async function checkRequiredDependencies(context) {
  const { workDir: studioPath, output } = context, [studioPackageManifest, installedStyledComponentsVersion, installedSanityVersion] = await Promise.all([
  ...
  ]), wantedStyledComponentsVersionRange = peerDependencies["styled-components"];
  ...
  if (!declaredStyledComponentsVersion) {
    ...
    return await installDependencies({ "styled-components": wantedStyledComponentsVersionRange }, context), await execa__default.default(file, args, { cwd: studioPath, stdio: "inherit" }), { didInstall: !0, installedSanityVersion };
  }
  ...
  return semver__default.default.satisfies(installedStyledComponentsVersion, wantedStyledComponentsVersionRange) || output.warn(oneline__default.default`
      ...
      is not compatible with the version required by sanity (${wantedStyledComponentsVersionRange}).
      This might cause problems!
    `), { didInstall: !1, installedSanityVersion };
}
...
exports.readPackageJson = readPackageJson$1;
