...
const ConnectorContext = createContext({
  ...
  enabled: !1,
  legacyEditing: !1
}), ValidationContext = createContext([]), LocaleContext = createContext(void 0), FormFieldPresenceContext = createContext([]), DocumentActionPropsContext = createContext(void 0), ScheduledPublishingEnabledContext = createContext(null), SchedulePublishUpsellContext = createContext({
  upsellData: null,
...
}), DocumentPaneContext = createContext(null), DocumentSheetListContext = createContext(
  void 0
), StructureToolContext = createContext(null);
export {
