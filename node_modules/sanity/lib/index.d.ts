...
import {ObjectSchemaType as ObjectSchemaType_2} from 'sanity'
...
import {Path as Path_2} from 'sanity'
...
>(props: ArrayInputFunctionsProps<Item, TSchemaType>): JSX_2.Element
...
export declare const ContextMenuButton: ForwardRefExoticComponent<
  ContextMenuButtonProps &
    Pick<HTMLProps<HTMLButtonElement>, 'hidden' | 'disabled' | 'onClick'> &
    RefAttributes<HTMLButtonElement>
>
...
export declare const DiffCard: ForwardRefExoticComponent<
  Omit<DiffCardProps & Omit<HTMLProps<HTMLElement>, 'height' | 'as'>, 'ref'> &
 ...
 * @internal
 */
export declare function EditScheduleForm(props: PropsWithChildren<Props>): JSX_2.Element
 ...
 * @internal
 */
export declare function Filters({showTypeFilter}: {showTypeFilter?: boolean}): JSX_2.Element
...
export declare const FormField: NamedExoticComponent<
  FormFieldProps & Omit<HTMLProps<HTMLDivElement>, 'height' | 'as' | 'ref'>
>
...
export declare function IsLastPaneProvider({
  children,
  isLastPane,
}: IsLastPaneProviderProps): JSX.Element
...
/** @public */
export declare interface RenderPortableTextInputEditableProps extends PortableTextEditableProps {
 ...
 * @beta
 */
export declare const ScheduleAction: (
 ...
 * @internal
 */
export declare function shouldArrayDialogOpen(schemaType: ObjectSchemaType_2, path: Path_2): boolean
...
export declare const StatusButton: ForwardRefExoticComponent<
  (StatusButtonProps & Omit<HTMLProps<HTMLButtonElement>, 'title' | 'disabled' | 'size' | 'ref'>) &
    RefAttributes<HTMLButtonElement>
>
...
declare const studioLocaleStrings: {
  ...
  'package-version.new-package-available.description': string
...
/** @internal */
export declare function useFeatureEnabled(featureKey: string): Features_2
