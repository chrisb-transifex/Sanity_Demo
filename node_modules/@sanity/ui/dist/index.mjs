...
const Popover = memo(
  forwardRef(function(props, forwardedRef) {
    ...
    const middleware = useMemo(() => {
      ...
      preventOverflow,
      referenceBoundary
    ]), { x, y, middlewareData, placement, refs, strategy, update } = useFloating({
      middleware,
...
function AutocompleteOption(props) {
  const { children, id, onSelect, selected, value } = props, handleClick = useCallback(() => {
    setTimeout(() => {
      onSelect(value);
    }, 0);
    ...
    if (maxLength && len > maxLength) {
      ...
      return [
        ...
        /* @__PURE__ */ jsx(
          ...
          {
            constrainSize: !0,
            content: /* @__PURE__ */ jsx(Stack, { as: "ol", overflow: "auto", padding: space, space, children: rawItems.slice(beforeLength - 1, len - afterLength) }),
            open,
            placement: "top",
            portal: !0,
...
`, DialogCard = forwardRef(function(props, forwardedRef) {
  ...
  const dialog = useDialog(), { layer } = useTheme_v2(), {
    ...
    [onFocus]
  ), labelId = `${id}_label`, rootClickTimeoutRef = useRef(), handleRootClick = useCallback(() => {
...
function MenuGroup(props) {
  ...
  return /* @__PURE__ */ jsx(Popover, { ...popover, content: childMenu, "data-ui": "MenuGroup__popover", open, children: /* @__PURE__ */ jsx(
    Selectable,
    {
      "data-as": as,
      "data-ui": "MenuGroup",
  ...
  return /* @__PURE__ */ jsx(
    Root$2,
    {
      ...
      children: /* @__PURE__ */ jsxs(Flex, { align: "flex-start", children: [
        ...
        closable && /* @__PURE__ */ jsx(Box, { padding: 1, children: /* @__PURE__ */ jsx(
          Button,
          {
            as: "button",
            icon: CloseIcon,
