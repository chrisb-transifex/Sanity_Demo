...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources3-QRC2PRLX.js")
});
...
function PaneItemPreview(props) {
  const { icon, layout, presence, schemaType, value } = props, title = isRecord$4(value.title) && (0, import_react.isValidElement)(value.title) || (0, import_isString.default)(value.title) || (0, import_isNumber.default)(value.title) ? value.title : null, previewStateObservable = (0, import_react.useMemo)(
...
var PaneHeaderActions = (0, import_react.memo)(function(props) {
  const {
    initialValueTemplateItems: initialValueTemplateItemsFromStructure = EMPTY_ARRAY$w,
    menuItems = EMPTY_ARRAY$w,
    menuItemGroups = EMPTY_ARRAY$w,
...
var ReferenceChangedBanner = (0, import_react.memo)(() => {
  ...
  }, [documentPreviewStore, parentId, parentRefPath]), referenceInfo = useObservable(referenceInfoObservable, { loading: true }), handleReloadReference = (0, import_react.useCallback)(() => {
    var _a2;
...
function DocumentStatusBarActionsInner(props) {
  var _a, _b, _c;
  const { disabled, showMenu, states } = props, { __internal_tasks, schemaType, openPath } = useDocumentPane(), [firstActionState, ...menuActionStates] = states, [buttonElement, setButtonElement] = (0, import_react.useState)(null), isTreeArrayEditingEnabled = (_c = (_b = (_a = useSource().features) == null ? void 0 : _a.beta) == null ? void 0 : _b.treeArrayEditing) == null ? void 0 : _c.enabled, isTreeArrayEditingEnabledOpen = (0, import_react.useMemo)(() => isTreeArrayEditingEnabled ? shouldArrayDialogOpen(schemaType, openPath) : false, [isTreeArrayEditingEnabled, openPath, schemaType]), tooltipContent = (0, import_react.useMemo)(() => !firstActionState || !firstActionState.title && !firstActionState.shortcut ? null : (0, import_jsx_runtime.jsxs)(Flex, { style: { maxWidth: 300 }, align: "center", gap: 3, children: [
...
function usePreviewUrl(value) {
  const { resolveProductionUrl } = useSource().document, subject = (0, import_react.useMemo)(
  ...
  const resolvedUrlObservable = (0, import_react.useMemo)(() => subject.asObservable().pipe(
...
var DocumentPaneProvider = (0, import_react.memo)((props) => {
  const { children, index, pane: pane2, paneKey, onFocusPath } = props, schema = useSchema(), templates = useTemplates(), {
    ...
    () => params.path ? fromString(params.path) : EMPTY_ARRAY$w
  ...
  const currentInspector = inspectors2 == null ? void 0 : inspectors2.find((i) => i.name === inspectorName), resolvedChangesInspector = inspectors2.find((i) => i.name === HISTORY_INSPECTOR_NAME), changesOpen = (currentInspector == null ? void 0 : currentInspector.name) === HISTORY_INSPECTOR_NAME, { t } = useTranslation2(structureLocaleNamespace), inspectOpen = params.inspect === "on", compareValue = changesOpen ? sinceAttributes : (editState == null ? void 0 : editState.published) || null, fieldActions = (0, import_react.useMemo)(
    ...
    (blurredPath) => {
      disableBlurRef.current || (setFocusPath(EMPTY_ARRAY$w), focusPathRef.current !== EMPTY_ARRAY$w && (focusPathRef.current = EMPTY_ARRAY$w, onFocusPath == null || onFocusPath(EMPTY_ARRAY$w)));
    },
...
var PreviewCell = (props) => {
  var _a, _b;
  const { documentPreviewStore, row, schemaType } = props, title = "Document title", previewStateObservable = (0, import_react.useMemo)(
...
var addSelectedStateToMenuItems = (options) => {
  ...
  return menuItems == null ? void 0 : menuItems.map((item) => {
    ...
    return (_a = item.params) != null && _a.layout ? {
      ...
      ...item,
      selected: (0, import_isEqual.default)(sortOrderRaw == null ? void 0 : sortOrderRaw.by, ((_d = item == null ? void 0 : item.params) == null ? void 0 : _d.by) || EMPTY_ARRAY$w)
    } : { ...item, selected: false };
  });
};
...
var PaneContainer = (0, import_react.memo)(function(props) {
  const { index, isSelected, pane: pane2, paneKey } = props, { name: parentSourceName } = useSource(), {
    ...
    initialValueTemplates = EMPTY_ARRAY$w,
    menuItemGroups,
    menuItems,
    options
  } = pane2, { defaultOrdering = EMPTY_ARRAY$w, filter: filter2 } = options, params = useShallowUnique(options.params || EMPTY_RECORD), sourceName = pane2.source, typeName = (0, import_react.useMemo)(() => {
    const staticTypes = findStaticTypesInFilter(filter2, params);
    return (staticTypes == null ? void 0 : staticTypes.length) === 1 ? staticTypes[0] : null;
    ...
    tools: [
      {
        ...
        icon,
        component: (0, import_react.lazy)(() => import("./index3-MDX723G5.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-VE4SZ5K4.js.map
