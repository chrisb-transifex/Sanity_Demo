...
// node_modules/sanity/lib/_chunks-es/resources3.mjs
var structureLocaleStrings = defineLocalesResources("structure", {
  ...
  "banners.permission-check-banner.missing-permission_create_one": "Your role <Roles/> does not have permissions to create this document.",
  /** The text for the permission check banner if the user only has multiple roles, but they do not allow updating this document */
  "banners.permission-check-banner.missing-permission_create_other": "Your roles <Roles/> do not have permissions to create this document.",
  /** The text for the permission check banner if the user only has one role, and it does not allow updating this document */
  "banners.permission-check-banner.missing-permission_update_one": "Your role <Roles/> does not have permissions to update this document.",
  /** The text for the permission check banner if the user only has multiple roles, but they do not allow updating this document */
  "banners.permission-check-banner.missing-permission_update_other": "Your roles <Roles/> do not have permissions to update this document.",
  ...
  "confirm-delete-dialog.confirmation.text_delete": "Are you sure you want to delete “<DocumentTitle/>”?",
  /** If no referring documents are found, this text appears above the cancel and confirmation buttons */
  ...
  "panes.document-operation-results.operation-success": "Successfully performed {{context}} on document",
  /** The text when a delete operation succeeded  */
  "panes.document-operation-results.operation-success_delete": "The document was successfully deleted",
  /** The text when a discard changes operation succeeded  */
  "panes.document-operation-results.operation-success_discardChanges": "All changes since last publish has now been discarded. The discarded draft can still be recovered from history",
  ...
  "panes.document-operation-results.operation-success_unpublish": "<Strong>{{title}}</Strong> was unpublished. A draft has been created from the latest published version.",
...
//# sourceMappingURL=resources3-QRC2PRLX.js.map
